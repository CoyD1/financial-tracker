            ...
            <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <h1 className="text-2xl font-bold text-white tracking-widest uppercase">FinanceTracker</h1>
            ...
            <div className="App">
                <Routes>
                    ...
                    <Route
                        ...
                        element={
                            isAuthenticated ?
                                <MainLayout onLogout={handleLogout}><AddTransactionForm /></MainLayout> :
                                <Navigate to="/" replace />
                        }
                    />
                    ...
                    <Route
                        ...
                        element={
                            isAuthenticated ?
                                <MainLayout onLogout={handleLogout}><TransactionHistory /></MainLayout> :
                                <Navigate to="/" replace />
                        }
                    />
